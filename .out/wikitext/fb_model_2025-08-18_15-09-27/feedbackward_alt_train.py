...
def main():
    ...
    if config.training.resume:
        ...
        run_prefix = config.training.fb_run_name
    ...
    if out_dir is None:
        ...
        run_name_with_timestamp = f"{config.training.fb_run_name}_{timestamp}"
        ...
        source_files_to_save = [
            'model.py', 'data_utils.py', 'utils.py', 'feedbackward_alt_train.py', 'custom_logger.py'
        ]
    ...
    fb_model = FeedbackwardModel(config.model, dataset_config)
